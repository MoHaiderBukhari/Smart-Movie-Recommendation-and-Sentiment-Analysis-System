...
export const movies: Movie[] = [
  ...
  // === MovieLens Popular Titles Expansion ===
  {
    id: 47, title: "Jurassic Park", year: 1993,
    genres: ["Action", "Adventure", "Sci-Fi"],
    rating: 8.2,
    ...
    reviews: [
      { text: "Spielberg made dinosaurs real. A landmark in cinema.", sentiment: "positive", score: 0.95 },
      { text: "The T-Rex scene is still the most thrilling sequence ever filmed.", sentiment: "positive", score: 0.93 },
      { text: "The science is laughable but the spectacle is unmatched.", sentiment: "neutral", score: 0.2 },
      { text: "Jeff Goldblum steals every scene he's in.", sentiment: "positive", score: 0.82 },
    ],
  },
  {
    id: 48, title: "The Terminator", year: 1984,
    genres: ["Action", "Sci-Fi"],
    rating: 8.1,
    ...
    overview: "A human soldier is sent from 2029 to 1984 to stop an almost indestructible cyborg killing machine sent from the same year to kill a young woman.",
    reviews: [
      { text: "James Cameron's lean, mean sci-fi thriller. Schwarzenegger is iconic.", sentiment: "positive", score: 0.91 },
      { text: "Low budget but maximum impact. A genre-defining classic.", sentiment: "positive", score: 0.88 },
      { text: "Dated effects but the tension never lets up.", sentiment: "neutral", score: 0.3 },
    ],
  },
  {
    id: 49, title: "Back to the Future", year: 1985,
    genres: ["Adventure", "Comedy", "Sci-Fi"],
    rating: 8.5,
    poster: "https://m.media-amazon.com/images/M/MV5BZmU0M2Y1OGUtZjIxNi00ZjBkLTg1MjgtOWIyNThiZWIwYjRiXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SX300.jpg",
    overview: "Marty McFly, a 17-year-old high school student, is accidentally sent 30 years into the past in a time-traveling DeLorean invented by his close friend, Dr. Emmett Brown.",
    reviews: [
      { text: "The perfect adventure film. Fun, clever, and endlessly rewatchable.", sentiment: "positive", score: 0.96 },
      { text: "Michael J. Fox and Christopher Lloyd are a legendary duo.", sentiment: "positive", score: 0.92 },
      { text: "Pure 80s nostalgia that never gets old.", sentiment: "positive", score: 0.85 },
    ],
  },
  {
    id: 50, title: "Titanic", year: 1997,
    genres: ["Drama", "Romance"],
    rating: 7.9,
    poster: "https://m.media-amazon.com/images/M/MV5BMDdmZGU3NDQtY2E5My00ZTliLWIzOTUtMTY4ZGI1YjdiNjk3XkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_SX300.jpg",
    overview: "A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.",
    reviews: [
      { text: "An epic love story set against one of history's greatest tragedies.", sentiment: "positive", score: 0.9 },
      { text: "The sinking sequence is cinema at its most spectacular.", sentiment: "positive", score: 0.92 },
      { text: "Overlong and the dialogue is painfully cheesy.", sentiment: "negative", score: -0.5 },
      { text: "Leonardo DiCaprio and Kate Winslet have undeniable chemistry.", sentiment: "positive", score: 0.83 },
    ],
  },
  {
    id: 51, title: "Psycho", year: 1960,
    genres: ["Horror", "Mystery", "Thriller"],
    rating: 8.5,
    poster: "https://m.media-amazon.com/images/M/MV5BNTQwNDM1YzItNDAxZC00NWY2LTk0M2UtNDIwYjE1OTUzOTM5XkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_SX300.jpg",
    ...
    reviews: [
      { text: "Hitchcock invented the modern horror film with this masterpiece.", sentiment: "positive", score: 0.96 },
      { text: "The shower scene changed cinema forever.", sentiment: "positive", score: 0.9 },
      { text: "Anthony Perkins is deeply unsettling as Norman Bates.", sentiment: "positive", score: 0.88 },
      { text: "Feels tame by modern horror standards.", sentiment: "negative", score: -0.25 },
    ],
  },
  {
    id: 52, title: "Taxi Driver", year: 1976,
    genres: ["Crime", "Drama"],
    rating: 8.2,
    ...
    overview: "A mentally unstable veteran works as a nighttime taxi driver in New York City, where the perceived decadence and sleaze fuels his uncontrollable urge for violent action.",
    reviews: [
      { text: "De Niro's Travis Bickle is one of cinema's most complex characters.", sentiment: "positive", score: 0.93 },
      { text: "Scorsese captures the grim underbelly of 1970s New York perfectly.", sentiment: "positive", score: 0.87 },
      { text: "Disturbing and uncomfortable, but that's the point.", sentiment: "neutral", score: 0.15 },
    ],
  },
  {
    id: 53, title: "The Breakfast Club", year: 1985,
    genres: ["Comedy", "Drama"],
    rating: 7.8,
    poster: "https://m.media-amazon.com/images/M/MV5BOTM5N2ZmZTMtNjlmOS00YzlkLTk3YjEtNTU1ZmQ5OTdhODZhXkEyXkFqcGc@._V1_SX300.jpg",
    overview: "Five high school students meet in Saturday detention and discover how much they actually have in common.",
    reviews: [
      { text: "John Hughes understood teenagers better than anyone.", sentiment: "positive", score: 0.91 },
      { text: "A timeless portrait of adolescent identity and rebellion.", sentiment: "positive", score: 0.86 },
      { text: "Dated in some ways but the core message still resonates.", sentiment: "neutral", score: 0.25 },
    ],
  },
  {
    id: 54, title: "Eternal Sunshine of the Spotless Mind", year: 2004,
    ...
    reviews: [
      { text: "The most beautiful and heartbreaking love story of the 2000s.", sentiment: "positive", score: 0.95 },
      { text: "Jim Carrey proves once again he's a dramatic powerhouse.", sentiment: "positive", score: 0.88 },
      { text: "Charlie Kaufman's script is pure genius.", sentiment: "positive", score: 0.92 },
      { text: "Confusing narrative structure that loses some viewers.", sentiment: "negative", score: -0.3 },
    ],
  },
  {
    id: 55, title: "Reservoir Dogs", year: 1992,
    genres: ["Crime", "Drama", "Thriller"],
    rating: 8.3,
    ...
    reviews: [
      { text: "Tarantino burst onto the scene with this electrifying debut.", sentiment: "positive", score: 0.93 },
      { text: "The ear scene is still shocking decades later.", sentiment: "positive", score: 0.75 },
      { text: "All style, no depth. Just violence for shock value.", sentiment: "negative", score: -0.55 },
    ],
  },
  {
    id: 56, title: "Amélie", year: 2001,
    ...
    reviews: [
      { text: "A whimsical, colorful fairy tale for adults. Utterly charming.", sentiment: "positive", score: 0.95 },
      { text: "Audrey Tautou is enchanting in every frame.", sentiment: "positive", score: 0.9 },
      { text: "Too saccharine and precious for some tastes.", sentiment: "negative", score: -0.3 },
    ],
  },
  {
    id: 57, title: "The Shining", year: 1980,
    genres: ["Drama", "Horror"],
    rating: 8.4,
    poster: "https://m.media-amazon.com/images/M/MV5BZWFlYmY2MGEtZjVkYS00YzU4LTg0YjQtYzY1ZGE3NTA5NGQxXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SX300.jpg",
    overview: "A family heads to an isolated hotel for the winter where a sinister presence influences the father into violence, while his psychic son sees horrific forebodings.",
    reviews: [
      { text: "Kubrick creates an atmosphere of pure dread that's never been matched.", sentiment: "positive", score: 0.94 },
      { text: "Jack Nicholson's performance is both terrifying and mesmerizing.", sentiment: "positive", score: 0.91 },
      { text: "Slow and pretentious. Stephen King was right to hate it.", sentiment: "negative", score: -0.5 },
      { text: "The Overlook Hotel is a character in itself.", sentiment: "positive", score: 0.8 },
    ],
  },
  {
    id: 58, title: "Oldboy", year: 2003,
    ...
    reviews: [
      { text: "Park Chan-wook crafted the ultimate revenge thriller.", sentiment: "positive", score: 0.94 },
      { text: "The corridor fight scene is legendary filmmaking.", sentiment: "positive", score: 0.91 },
      { text: "The ending is devastating and unforgettable.", sentiment: "positive", score: 0.85 },
      { text: "Excessively violent and deeply disturbing.", sentiment: "negative", score: -0.6 },
    ],
  },
  {
    id: 59, title: "Pan's Labyrinth", year: 2006,
    genres: ["Drama", "Fantasy", "War"],
    rating: 8.2,
    poster: "https://m.media-amazon.com/images/M/MV5BYzFjMThiMGItOWRlMC00MDI4LThmOGUtYTNkNWFiNmE3MDIxXkEyXkFqcGc@._V1_SX300.jpg",
    ...
    reviews: [
      { text: "Guillermo del Toro's dark fairy tale is a work of art.", sentiment: "positive", score: 0.95 },
      { text: "The Pale Man is the most terrifying creature in film history.", sentiment: "positive", score: 0.88 },
      { text: "Beautiful but harrowing. Not for the faint of heart.", sentiment: "neutral", score: 0.2 },
    ],
  },
  {
    id: 60, title: "Groundhog Day", year: 1993,
    genres: ["Comedy", "Fantasy", "Romance"],
    rating: 8.0,
    poster: "https://m.media-amazon.com/images/M/MV5BZWIxNzM5NzQtY2FjNi00ZTViLWIxYTgtMjkxZjRmOWQ3MjVhXkEyXkFqcGc@._V1_SX300.jpg",
    overview: "A self-centered Pittsburgh weatherman finds himself inexplicably trapped in a small town as he lives the same day over and over again.",
    reviews: [
      { text: "Bill Murray's finest hour. A comedy with genuine philosophical depth.", sentiment: "positive", score: 0.94 },
      { text: "Gets better and more meaningful with every rewatch.", sentiment: "positive", score: 0.89 },
      { text: "A simple premise executed to absolute perfection.", sentiment: "positive", score: 0.85 },
    ],
  },
  {
    id: 61, title: "Seven", year: 1995,
    genres: ["Crime", "Drama", "Mystery", "Thriller"],
    rating: 8.6,
    poster: "https://m.media-amazon.com/images/M/MV5BY2IzNGNiODgtN2YzNi00YWFlLWFlNjQtNDBiYTU0ZjcxMDcxXkEyXkFqcGc@._V1_SX300.jpg",
    overview: "Two detectives, a rookie and a veteran, hunt a serial killer who uses the seven deadly sins as his motifs.",
    reviews: [
      { text: "Dark, disturbing, and utterly gripping from start to finish.", sentiment: "positive", score: 0.93 },
      { text: "The ending is one of the most shocking in cinema history.", sentiment: "positive", score: 0.9 },
      { text: "Brad Pitt and Morgan Freeman have incredible chemistry.", sentiment: "positive", score: 0.85 },
      { text: "Nihilistic and gratuitously bleak.", sentiment: "negative", score: -0.55 },
    ],
  },
  {
    id: 62, title: "Rear Window", year: 1954,
    ...
    overview: "A photographer in a wheelchair spies on his neighbors from his Greenwich Village apartment window and becomes convinced one of them has committed murder.",
    reviews: [
      { text: "Hitchcock's masterclass in suspense. Every frame is deliberate.", sentiment: "positive", score: 0.95 },
      { text: "Jimmy Stewart and Grace Kelly are magnetic together.", sentiment: "positive", score: 0.89 },
      { text: "Slow by modern standards but utterly riveting.", sentiment: "neutral", score: 0.3 },
    ],
  },
  {
    id: 63, title: "2001: A Space Odyssey", year: 1968,
    genres: ["Adventure", "Sci-Fi"],
    rating: 8.3,
    poster: "https://m.media-amazon.com/images/M/MV5BMmNlYzRiNDctZWNhMi00MzI4LThkZTctMTUzMmZkMmFiMmEwXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_SX300.jpg",
    overview: "After uncovering a mysterious artifact buried beneath the lunar surface, a spacecraft is sent to Jupiter to find its origins—a voyage jeopardized by the ship's computer, HAL 9000.",
    reviews: [
      { text: "The most visionary science fiction film ever made.", sentiment: "positive", score: 0.96 },
      { text: "Kubrick was decades ahead of his time. Visually unmatched.", sentiment: "positive", score: 0.93 },
      { text: "Pretentious, boring, and incomprehensible.", sentiment: "negative", score: -0.7 },
      { text: "HAL 9000 is the greatest AI villain in fiction.", sentiment: "positive", score: 0.85 },
    ],
  },
  {
    id: 64, title: "Casino Royale", year: 2006,
    genres: ["Action", "Adventure", "Thriller"],
    rating: 8.0,
    poster: "https://m.media-amazon.com/images/M/MV5BMDI5ZWJhOWItYTlhOC00YWNhLTlkNzctNDU5YTI1M2E1MWZhXkEyXkFqcGdeQXVyNTIzOTk5ODR@._V1_SX300.jpg",
    overview: "After earning 00 status and his licence to kill, Secret Agent James Bond sets out on his first mission as 007.",
    reviews: [
      { text: "Daniel Craig reinvented Bond for the modern era. Stunning debut.", sentiment: "positive", score: 0.93 },
      { text: "The poker scene is more thrilling than most action sequences.", sentiment: "positive", score: 0.88 },
      { text: "Gritty, grounded, and the best Bond film since Goldfinger.", sentiment: "positive", score: 0.85 },
      { text: "Too serious. Where's the fun of classic Bond?", sentiment: "negative", score: -0.35 },
    ],
  },
  {
    id: 65, title: "Up", year: 2009,
    genres: ["Animation", "Adventure", "Comedy", "Family"],
    rating: 8.3,
    poster: "https://m.media-amazon.com/images/M/MV5BYjBkM2RjMzItM2M3Ni00N2NjLWE3NzMtMGY4MjE2MzYxNWQ3XkEyXkFqcGc@._V1_SX300.jpg",
    ...
    reviews: [
      { text: "The first 10 minutes are the most emotionally devastating in animation history.", sentiment: "positive", score: 0.96 },
      { text: "Pixar proves once again that animated films can be deeply moving.", sentiment: "positive", score: 0.91 },
      { text: "The adventure part doesn't match the brilliant opening.", sentiment: "neutral", score: 0.1 },
    ],
  },
  {
    id: 66, title: "Blade Runner", year: 1982,
    genres: ["Action", "Drama", "Sci-Fi"],
    rating: 8.1,
    ...
    reviews: [
      { text: "A haunting, rain-soaked vision of the future that defined cyberpunk.", sentiment: "positive", score: 0.93 },
      { text: "Rutger Hauer's 'tears in rain' monologue is cinematic perfection.", sentiment: "positive", score: 0.95 },
      { text: "Glacially slow and confusing on first viewing.", sentiment: "negative", score: -0.4 },
    ],
  },
  {
    id: 67, title: "There Will Be Blood", year: 2007,
    genres: ["Drama"],
    rating: 8.2,
    poster: "https://m.media-amazon.com/images/M/MV5BMjAxODQ4MDU5NV5BMl5BanBnXkFtZTcwMDU4MjkxMw@@._V1_SX300.jpg",
    ...
    reviews: [
      { text: "Daniel Day-Lewis gives the greatest performance in cinema history.", sentiment: "positive", score: 0.98 },
      { text: "Paul Thomas Anderson crafted an American epic for the ages.", sentiment: "positive", score: 0.93 },
      { text: "Brutally long and relentlessly bleak.", sentiment: "negative", score: -0.45 },
    ],
  },
  {
    id: 68, title: "The Princess Bride", year: 1987,
    genres: ["Adventure", "Comedy", "Family", "Fantasy", "Romance"],
    rating: 8.0,
    poster: "https://m.media-amazon.com/images/M/MV5BYzE0MDljMzgtMjkzMy00NjE1LWIwNDItMzNhYTlhMDczNWRjXkEyXkFqcGc@._V1_SX300.jpg",
    overview: "While home sick in bed, a young boy's grandfather reads him the story of a farmboy-turned-pirate who encounters numerous obstacles to be reunited with his true love.",
    reviews: [
      { text: "Inconceivable! The most quotable and lovable film of the 80s.", sentiment: "positive", score: 0.95 },
      { text: "A perfect blend of romance, comedy, and adventure.", sentiment: "positive", score: 0.91 },
      { text: "Charming in a way that modern blockbusters can't replicate.", sentiment: "positive", score: 0.85 },
    ],
  },
  {
    id: 69, title: "City of God", year: 2002,
    genres: ["Crime", "Drama"],
    rating: 8.6,
    poster: "https://m.media-amazon.com/images/M/MV5BMGU1YTc4OTMtMmE0MS00Y2I1LTg2MjMtMzA3YjlkMTRmMDBjXkEyXkFqcGc@._V1_SX300.jpg",
    ...
    reviews: [
      { text: "Raw, visceral, and unforgettable. One of the best foreign films ever.", sentiment: "positive", score: 0.96 },
      { text: "The energy and style are electrifying from the very first frame.", sentiment: "positive", score: 0.92 },
      { text: "Relentlessly violent but impossible to look away from.", sentiment: "neutral", score: 0.15 },
    ],
  },
  {
    ...
    overview: "After young Riley is uprooted from her Midwest life and moved to San Francisco, her emotions — Joy, Fear, Anger, Disgust and Sadness — conflict on how to navigate a new city.",
    reviews: [
      { text: "Pixar's most inventive concept brought to life with incredible heart.", sentiment: "positive", score: 0.94 },
      { text: "A film that teaches emotional intelligence better than any textbook.", sentiment: "positive", score: 0.9 },
      { text: "Adults will cry harder than the kids.", sentiment: "positive", score: 0.78 },
      { text: "The concept is more interesting than the actual story.", sentiment: "neutral", score: 0.1 },
    ],
  },
  {
    id: 71, title: "The Big Lebowski", year: 1998,
    genres: ["Comedy", "Crime"],
    rating: 8.1,
    poster: "https://m.media-amazon.com/images/M/MV5BMTQ0NjUzMDMyOF5BMl5BanBnXkFtZTgwODA1OTU0MDE@._V1_SX300.jpg",
    overview: "Ultimate slacker Jeff 'The Dude' Lebowski, mistaken for a millionaire of the same name, seeks restitution for his ruined rug and enlists his bowling buddies to help.",
    reviews: [
      { text: "The Dude abides. The Coen Brothers' funniest and most quotable film.", sentiment: "positive", score: 0.93 },
      { text: "Jeff Bridges was born to play this role.", sentiment: "positive", score: 0.88 },
      { text: "Random, meandering, and pointless — and that's the charm.", sentiment: "neutral", score: 0.2 },
    ],
  },
  {
    id: 72, title: "Ratatouille", year: 2007,
    ...
    reviews: [
      { text: "Anyone can cook, and Pixar can do no wrong. A delicious film.", sentiment: "positive", score: 0.93 },
      { text: "Peter O'Toole's Anton Ego review speech is cinema perfection.", sentiment: "positive", score: 0.95 },
      { text: "The premise is hard to swallow — a rat in a kitchen?", sentiment: "negative", score: -0.3 },
    ],
  },
  {
    id: 73, title: "Jaws", year: 1975,
    genres: ["Adventure", "Thriller"],
    rating: 8.1,
    poster: "https://m.media-amazon.com/images/M/MV5BMmVmODY1MzEtYTMwZC00MzNhLWFkNDMtZjAwM2EwODUxZTBkXkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_SX300.jpg",
    ...
    reviews: [
      { text: "Spielberg invented the summer blockbuster. Still terrifying.", sentiment: "positive", score: 0.94 },
      { text: "The less you see the shark, the scarier it gets. Brilliant.", sentiment: "positive", score: 0.9 },
      { text: "Robert Shaw's USS Indianapolis monologue is unforgettable.", sentiment: "positive", score: 0.88 },
    ],
  },
  {
    id: 74, title: "Memento", year: 2000,
    genres: ["Mystery", "Thriller"],
    rating: 8.4,
    ...
    reviews: [
      { text: "Nolan's breakout film. A puzzle box that rewards repeat viewings.", sentiment: "positive", score: 0.93 },
      { text: "The reverse chronology is a stroke of genius.", sentiment: "positive", score: 0.9 },
      { text: "Guy Pearce is phenomenal in a deeply layered role.", sentiment: "positive", score: 0.85 },
      { text: "Gimmicky structure that masks a thin story.", sentiment: "negative", score: -0.4 },
    ],
  },
  {
    id: 75, title: "The Incredibles", year: 2004,
    ...
    reviews: [
      { text: "The best Fantastic Four movie ever made — and it's not even about them.", sentiment: "positive", score: 0.92 },
      { text: "Brad Bird understands superheroes better than most comic writers.", sentiment: "positive", score: 0.88 },
      { text: "Fun for the whole family with surprising emotional depth.", sentiment: "positive", score: 0.83 },
    ],
  },
  {
    id: 76, title: "Trainspotting", year: 1996,
    genres: ["Drama"],
    rating: 8.1,
    poster: "https://m.media-amazon.com/images/M/MV5BMzA5Zjc3ZTMtMmU5YS00YTMwLWI4MWUtYjU0YTllYjQ4Y2Q3XkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_SX300.jpg",
    overview: "Renton, deeply immersed in the Edinburgh drug scene, tries to clean up and get out, despite the allure of drugs and influence of friends.",
    reviews: [
      { text: "Danny Boyle's kinetic direction makes heroin addiction feel dangerously exciting.", sentiment: "positive", score: 0.87 },
      { text: "Ewan McGregor's 'Choose Life' monologue is iconic.", sentiment: "positive", score: 0.9 },
      { text: "Horrifying and darkly funny in equal measure.", sentiment: "neutral", score: 0.2 },
    ],
  },
];
